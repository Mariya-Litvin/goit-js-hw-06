...
// 1. Усі елементи галереї повинні додаватися в DOM за одну
//  операцію додавання.
// 2. Додай мінімальне оформлення галереї флексбоксами або
...
const elementGallery = images
  .map((image) => `<li> <img src =${image.url} alt =${image.alt}></img></li>`)
  .join("");

listGallery.insertAdjacentHTML("beforeend", elementGallery);
